document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        function validateField(input) {
            ...
            if (required && !value) {
                const fieldName = input.getAttribute('data-label') || name || 'This field';
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                if (submitBtn) {
                    ...
                    submitBtn.textContent = submitBtn.tagName === 'BUTTON' ? 'Sending...' : 'Sending...';
                    submitBtn.value = submitBtn.tagName === 'INPUT' ? 'Sending...' : submitBtn.value;
                    ...
                    setTimeout(function() {
                        ...
                        successMsg.style.cssText = 'color: #38a169; padding: 0.75rem; margin-top: 1rem; background: #f0fff4; border-radius: 0.25rem; text-align: center;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '9cabf1f1-58e5-4559-9489-c42912ea4f91',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '9cabf1f1-58e5-4559-9489-c42912ea4f91';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '9cabf1f1-58e5-4559-9489-c42912ea4f91';
